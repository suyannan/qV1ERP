<template>
  <div>
    <common-header :title="'采购管理'"></common-header>
    <div class="page-content">
      <common-header-tilte :title2="'采购订单列表'"></common-header-tilte>
      <el-form :inline="true" :model="params" class="demo-form-inline" style="text-align: left">
        <el-row>
          <el-col :span="4">
            <div class="el-form-item" style="width:100%;">
              ...
              <div class="el-form-item__content" style="width:75%;">
                <input v-model="params.order_num" placeholder="请输入订单号" class="el-input__inner" style="" @keyup.enter="search()">
              </div>
          ...
          <el-col :span="5">
            <el-form-item label="供应商名称" style="width:100%">
              <el-select v-model="params.supplier_id" placeholder="全部" filterable @change="search()">
        ...
        <el-row>
          <el-col :span="4">
            <div class="el-form-item" style="width:100%;">
              <label class="el-form-item__label" style="">采购主体</label>
          ...
          <el-col :span="4">
            <div class="el-form-item" style="width:100%;">
              <label class="el-form-item__label" style="">付款状态</label>
              <div class="el-form-item__content" style="width:65%;">
          ...
          <el-col :span="4">
            <div class="el-form-item" style="width:100%;">
              <label class="el-form-item__label" style="">收货状态</label>
              <div class="el-form-item__content" style="width:65%;">
      ...
      <el-table :data="tableData" max-height="450" border :summary-method="getSummaries" show-summary
        ...
        <el-table-column prop="s_name" label="供应商名称" width="120">
        </el-table-column>
        <el-table-column prop="chmc_name" label="存货名称" width="120">
        </el-table-column>
