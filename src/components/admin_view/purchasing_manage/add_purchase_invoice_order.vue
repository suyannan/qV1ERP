...
/* axios.defaults.withCredentials = true;*/
  import {edit_purchase_order_invoice} from '../../../api/index'
  ...
  export default {
    ...
    methods: {
      getData(){
        ...
        axios.get(config.purchase_order_invoice_detail+this.id).then(function (res) {
      ...
      save(){
        ...
        edit_purchase_order_invoice(obj).then(function (res) {
