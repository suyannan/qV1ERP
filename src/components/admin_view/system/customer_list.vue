<template>
  <div>
    <common-header :title="'系统维护'" :title1="'客户名称列表'"></common-header>
        ...
        <el-table-column label="操作" width="200">
          <template slot-scope="scope">
            <div v-if="system_edit==1">
              <el-button size="mini" type="primary"  @click="handleEdit(scope.$index, scope.row, 'edit')">编辑审核</el-button>
              <el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)">删除</el-button>
            </div>
            <div v-else>
              <el-button size="mini" type="primary"  disabled>编辑审核</el-button>
